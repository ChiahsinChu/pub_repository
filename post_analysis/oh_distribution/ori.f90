...
!      OPEN(12,FILE="distance.dat")
      OPEN(13,FILE="bridge_angle.dat")
      OPEN(14,FILE="top_angle.dat")
...
!              WRITE(12,*) d1,d2
      ...
      DO i=1,nbin
          WRITE(13,*) i*dphi-2.5,DBLE(g1(i))/DBLE(n1+n2)
          WRITE(14,*) i*dphi-2.5,DBLE(g2(i))/DBLE(n1+n2)
      END DO
