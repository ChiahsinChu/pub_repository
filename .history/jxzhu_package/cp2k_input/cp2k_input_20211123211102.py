...
def energy(output_file="./input.inp", charge=0, multiplicity=1, uks=False, kp=False, kp_mp="2 2 1", 
...
def geo_opt(output_file="./input.inp", charge=0, multiplicity=1, uks=False, kp=False, kp_mp="2 2 1", 
            dip_cor=False, eden=False, mo=False, pdos=False, hartree=False, 
...
def aimd(output_file="./input.inp", charge=0, multiplicity=1, uks=False, kp=False, kp_mp="2 2 1", 
            dip_cor=False, eden=False, mo=False, pdos=False, hartree=False, 
            restart=False, stride=1):
    input_dict = aimd
    if charge != 0:
