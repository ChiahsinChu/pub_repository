...
def make_cp2k_input(atoms, input_dict, fp_params={}):
    """
    Args:
    ...
    dpgen_cp2k.update_dict(default_config, user_config)
    dpgen_cp2k.update_dict(default_config, cell_config)
    #output list
    input_str = []
    dpgen_cp2k.iterdict(default_config, input_str)
    string="\n".join(input_str)
    return string
