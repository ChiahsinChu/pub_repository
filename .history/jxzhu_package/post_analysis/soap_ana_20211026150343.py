...
def gen_quip_atom_soap(xyz_file, param, desc):
    """
    generate atom soap for a xyz trajectory file given descriptor (`desc`)
    by quip 
    """
    data_list = []
    for atoms in iread(xyz_file):
        ...
        atoms.set_pbc(True)
        data = gen_quip_soap(atoms, desc) 
        data_list.append(data)
    return np.array(data_list)

# TODO: quip_frame_soap
def gen_quip_frame_soap(xyz_file, param, desc):
    """
