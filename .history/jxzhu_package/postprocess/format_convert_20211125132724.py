...
import numpy as np
from ase import atoms, io, Atom, Atoms
...
def npy_to_xyz(data_dir, output_dir, output_file="reftraj.xyz"):
    ...
    type_list = read_type_list(data_dir +  "/type.raw")
    for l in l_set:
...
def xyz_to_npy(pos_file, frc_file, cell_param, type_map, output_dir="./system"):
    ...
    if os.path.exists(output_dir):
        ...
        type_list = get_type_list(atoms, type_map)
...
def get_type_list(atoms, type_map):
