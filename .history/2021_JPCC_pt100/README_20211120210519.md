...
- `script`: f
> I find a simpler way to compute the Fermi level and electrostatic potentials of a series of snapshots. See directory `alternative`.


### post analysis

> NOTE: Most of the codes here are written in fortran and *ad hoc*. Some of them are reconstructed in python modules for higher transferability, which can be found in [GitHub]().
