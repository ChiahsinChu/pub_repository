...
awk '{if ($1<=2.7) {i++;s=s+$2; print (s/i)*(11.246*11.246*2.7*6.02/180)/16}}' o.dat >> wata_cov.dat
awk '{if ($1<=4.5) {i++;s=s+$2; print (s/i)*(11.246*11.246*4.5*6.02/180)/16}}' o.dat >> watb_cov.dat
